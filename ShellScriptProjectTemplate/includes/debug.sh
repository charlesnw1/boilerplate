...
#While the above can be (per http://redsymbol.net/articles/unofficial-bash-strict-mode/ 
#done via : #set -euo pipefail 
#I stronlgy prefer verbosity. Especially in framework code)
